<x-app-layout>
  <x-slot name="header">
    <h5 class="m-0">{{ __('Crear Operativo') }}</h5>
  </x-slot>

  <x-slot name="breadcrumb">
    <li class="breadcrumb-item"><a href="/operativos/">Operativos</a></li>
    <li class="breadcrumb-item active">Crear Operativo</li>
  </x-slot>
    <div class="row">
      <div class="col-md-9">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="/operativos" method="post">
              {!! csrf_field() !!}
              ...
              <label>Jefe</label></br>
              <input type="text" name="jefe" id="jefe" class="form-control"></br>
